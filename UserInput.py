class UserInput:
    ...
    def __init__(self, rangeBegin, rangeEnd, epochs, paramNum, precision, populationSize, crossMethod, crossProbability,
                 ...
                 percentBestToSelect, optimizationMethod, tournamentSize=None):
