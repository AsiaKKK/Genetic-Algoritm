...
class GeneticAlgorithm:
    def __init__(self, user_input):
        ...
        self._selection_methods = {
            'Best Selection': GeneticOperators.selection_best,
            'Roulette Selection': GeneticOperators.selection_roulette,
            'Tournament Selection': GeneticOperators.selection_tournament
        }
...
{tournament_line}    Best to select:     {self.user_input.percent_best_to_select}
    Crossover:          {self.user_input.cross_method} (a = {self.user_input.alpha}, b={self.user_input.beta})
    ...
    def _mutation(self, offspring):
        ...
        offspring = mutation_function(offspring, self.user_input)
